...
extern "C" {
#endif
void  rmaPropagate0_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate0_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate1_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate2_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate2_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate3_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate3_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate4_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate4_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate5_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate5_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate6_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate6_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate7_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate7_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate8_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate8_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate9_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate9_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate10_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate10_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate11_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate11_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_p_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_f_spi_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate12_r_spi_simv_daidir (UB  * pcode);
void  rmaPropagate12_wn_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_spi_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_spi_simv_daidir (UB  * pcode, scalar  val);
